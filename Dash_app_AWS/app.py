...
def nav_bar():
    ...
    [
        ...
        dbc.Nav(
            [
                dbc.NavLink("Portfolio", href="https://jurioste4.github.io/",active="exact",  external_link=True),
                dbc.NavLink("Linkten", href="https://www.linkedin.com/in/jeromeurioste", active="exact", external_link=True)
            ],
            pills=True,
            vertical=True
        ),
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.H4('References '),
                        html.P(dbc.NavLink("Life Expectancy", active=True, href="https://data.oecd.org/healthstat/life-expectancy-at-birth.htm")),
                        html.P(dbc.NavLink("Spending", active=True, href="https://data.oecd.org/healthres/health-spending.htm")),
                        html.P(dbc.NavLink("Performance", active=True, href="https://www.who.int/healthinfo/paper30.pdf"))
                    ],
                    width=1
